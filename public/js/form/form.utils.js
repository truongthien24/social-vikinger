/*-----------------
    FORM INPUT
-----------------*/
document.querySelector('.form-input', function (elements) {
...
/*-------------------
    FORM COUNTER
-------------------*/
document.querySelector('.form-counter', function (counters) {
...
/*-------------------
    FORM SWITCH
-------------------*/
document.querySelector('.form-switch', function (switchInputs) {
...
/*------------------
    FORM RATING
------------------*/
document.querySelector('.form-rating', function (ratingInputs) {
...
/*------------------------
    INTERACTIVE INPUT
------------------------*/
document.querySelector('.interactive-input', function (elements) {
  for (const el of elements) {
    const input = el.querySelector('input'),
